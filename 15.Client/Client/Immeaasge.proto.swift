...
public struct ImmeaasgeRoot {
    public static let `default` = ImmeaasgeRoot()
...
extension UserInfo: GeneratedMessageProtocol {
    ...
    public class func parseFrom(data: Data) throws -> UserInfo {
        return try UserInfo.Builder().mergeFrom(data: data, extensionRegistry:ImmeaasgeRoot.default.extensionRegistry).build()
    }
...
extension TextMessage: GeneratedMessageProtocol {
    ...
    public class func parseFrom(data: Data) throws -> TextMessage {
        return try TextMessage.Builder().mergeFrom(data: data, extensionRegistry:ImmeaasgeRoot.default.extensionRegistry).build()
    }
...
extension GiftMessage: GeneratedMessageProtocol {
    ...
    public class func parseFrom(data: Data) throws -> GiftMessage {
        return try GiftMessage.Builder().mergeFrom(data: data, extensionRegistry:ImmeaasgeRoot.default.extensionRegistry).build()
    }
